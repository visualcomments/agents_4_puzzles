...
def build_parser() -> argparse.ArgumentParser:
    ...
    sp.add_argument("--prompt-variant", default=None, choices=["regular", "improved", "dataset_adapted", "structured", "heuristic_boosted", "master_hybrid", "score_guarded", "algorithmic_population", "portfolio_orchestrated", "hard_row_routed", "exact_score_population"], help="Select a competition prompt bundle variant when available")
