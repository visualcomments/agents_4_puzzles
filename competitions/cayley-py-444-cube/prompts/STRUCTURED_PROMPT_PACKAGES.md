# Structured prompt packages for 4x4x4 cube
...
All 4x4x4 cube prompt variants now require the coder and fixer to return one machine-readable JSON object with the shared `code_response.v2` contract:
